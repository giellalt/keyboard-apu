...
keyboards for the Apurinã language. The data and implementations
...
* http://giellatekno.uit.no/apudoc/index.html
* http://divvun.no/doc/tools/docu-apu-manual.html
...
The Apurinã keyboard sources can be acquired using the `Giella SVN
